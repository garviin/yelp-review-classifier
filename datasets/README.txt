...
Collective Opinion Spam Detection using Active Inference. Shebuti Rayana, Leman Akoglu,SIAMSDM, Miami, Florida, USA, May 5-7, 2016
...
To load the file in Python:
	vocab = pickle.load(open("train_countvec_vocabulary.pkl", "rb"))
